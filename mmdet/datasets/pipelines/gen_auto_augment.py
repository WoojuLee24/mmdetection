...
def bbox2fields():
    ...
    bbox2instance = {
        'gt_bboxes': 'gt_instance_inds'
    }
    return bbox2label, bbox2mask, bbox2seg, bbox2instance


@PIPELINES.register_module()
class GenAutoAugment:
    """Auto augmentation.
    ...
    def __init__(self, policies, num_gen=2):
...
class Shear:
    ...
    def _filter_invalid(self, results, min_bbox_size=0):
        ...
        augmentation."""
        bbox2label, bbox2mask, _, bbox2instance = bbox2fields()
        for key in results.get('bbox_fields', []):
            ...
            # instance inds.
            instance_key = bbox2instance.get(key)
            if instance_key in results:
                results[instance_key] = results[instance_key][valid_inds]
