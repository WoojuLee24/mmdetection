...
class RandomAffine2:
    ...
    def __call__(self, results):
        ...
        results['img'] = img
        results['img_shape'] = img.shape
        self.aug_parameters['trans_x'] = trans_x
        self.aug_parameters['trans_y'] = trans_y
        self.aug_parameters['rotation_degree'] = rotation_degree
        self.aug_parameters['scaling_ratio'] = scaling_ratio
        self.aug_parameters['rotation_matrix'] = rotation_matrix
        self.aug_parameters['scaling_matrix'] = scaling_matrix
        self.aug_parameters['shear_matrix'] = shear_matrix
        self.aug_parameters['translate_matrix'] = translate_matrix
        self.aug_parameters['warp_matrix'] = warp_matrix
        results['aug_parameters'] = self.aug_parameters
