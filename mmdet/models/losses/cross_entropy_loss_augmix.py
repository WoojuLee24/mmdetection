...
def binary_cross_entropy_augmix(pred,
                         label,
                         weight=None,
                         reduction='mean',
                         avg_factor=None,
...
class CrossEntropyLossAugMix(nn.Module):
    ...
    def __init__(self,
        ...
        """
        super(CrossEntropyLossAugMix, self).__init__()
        ...
        if self.use_sigmoid:
            self.cls_criterion = binary_cross_entropy_augmix
        elif self.use_mask:
            self.cls_criterion = mask_cross_entropy_augmix
        else:
            self.cls_criterion = cross_entropy_augmix
