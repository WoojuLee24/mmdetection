...
model = dict(
    ...
    train_cfg=dict(
        ...
        rcnn=dict(
            ...
            pos_weight=-1,
            debug=False),
        additional_loss=['frame_mask_loss'],  # ['frame_loss'], ['aug_loss']       # additional_loss parameter
        lambda_weight=[0.1, 0.1, 0.1, 0.1],
        wandb=dict(
            log=dict(
                  ...
                  hooks=[
                      ...
                      dict(type='WandbLogger',
                           wandb_init_kwargs={'project': "KT_AI", 'entity': "kaist-url-ai28",
                                              'name': "faster_rcnn_r50_fpn_1e_openloris_frame_v0.1_lw0.1",
                                              },
