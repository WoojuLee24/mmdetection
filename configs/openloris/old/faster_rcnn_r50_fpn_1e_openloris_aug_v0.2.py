_base_ = [
    ...
    '../_base_/datasets/openloris_detection_aug.py',
...
model = dict(
    ...
    train_cfg=dict(
        ...
        rcnn=dict(
            ...
            pos_weight=-1,
            debug=False),
        additional_loss=['aug_lossv0.2'],  # ['frame_loss'], ['aug_loss'],  ['aug_lossv0.2'],      # additional_loss parameter
        feature_pooling_ratio=[8, 4, 2, 1],
        wandb=dict(
            log=dict(
