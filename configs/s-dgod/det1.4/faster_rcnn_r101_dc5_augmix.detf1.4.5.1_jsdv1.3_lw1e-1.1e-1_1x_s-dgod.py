    ...
    roi_head=dict(
        bbox_head=dict(
            ...
            loss_cls=dict(
                ...
                additional_loss='jsdv1_3_2aug', lambda_weight=0.1, wandb_name='roi_cls', log_pos_ratio=True),
...
train_pipeline = [
    ...
    ### AugMix ###
    dict(type='AugMixDetectionFaster', num_views=num_views, version='1.4.5.1.sdgod',
...
name = "faster_rcnn_r101_fpn_augmix.det1.4.4.1_jsdv1.3_lw1e-1.10_1x_s-dgod"
