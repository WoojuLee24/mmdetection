...
model = dict(
    ...
    roi_head=dict(
            ...
            bbox_head=dict(
                ...
                loss_cont=dict(type='ContrastiveLossPlus', version='1.0', loss_weight=0.0001, num_views=num_views,
...
train_pipeline = [
    ...
    ### AugMix ###
    dict(type='AugMixDetectionFaster', num_views=num_views, version='2.2.4.all',
