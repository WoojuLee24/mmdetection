    ...
    roi_head=dict(
        bbox_head=dict(
            ...
            loss_cls=dict(
                ...
                additional_loss='jsdv1_3', lambda_weight=10, wandb_name='roi_cls', log_pos_ratio=False,
...
log_config = dict(interval=100,
                  hooks=[
                      ...
                      #                         'name': "augmix.det1.2_plus_rpn.jsdv1.3.none_roi.jsdv1.3.none_ntxent.clean__e2_lw.1e-1.10.1e-2",
                      #                         'config': {
                      #                             # data pipeline
