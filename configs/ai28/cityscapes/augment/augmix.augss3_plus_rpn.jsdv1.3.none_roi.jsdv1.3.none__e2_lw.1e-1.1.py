    ...
    roi_head=dict(
        bbox_head=dict(
            loss_cls=dict(
                ...
                , additional_loss='jsdv1_3', lambda_weight=1, wandb_name='roi_cls'),
...
train_pipeline = [
    ...
    ### AugMix ###
    dict(type='AugMix', no_jsd=False, aug_list='augmentations', aug_severity=3, **img_norm_cfg),
