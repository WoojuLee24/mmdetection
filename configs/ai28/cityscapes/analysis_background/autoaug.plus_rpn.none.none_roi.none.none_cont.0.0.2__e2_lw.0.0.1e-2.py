    ...
    roi_head=dict(
        bbox_head=dict(
            ...
            loss_cls=dict(
                ...
                , additional_loss='None', lambda_weight=10, wandb_name='roi_cls'),
...
train_pipeline = [
    ...
    dict(
        ...
        num_gen=2,
        policies=[
            [dict(type='Shear', prob=1.0, level=5),
             dict(type='Rotate', prob=1.0, level=5),
             dict(type='ColorTransform', prob=1.0, level=3),],
            [dict(type='Translate', prob=1.0, level=3),
             dict(type='Rotate', prob=1.0, level=3),
             dict(type='ColorTransform', prob=1.0, level=8),
             dict(type='BrightnessTransform', prob=1.0, level=3),
             ],
            [dict(type='Rotate', prob=1.0, level=8),
             dict(type='EqualizeTransform', prob=1.0),
             dict(type='ContrastTransform', prob=1.0, level=8),],
        ]),
