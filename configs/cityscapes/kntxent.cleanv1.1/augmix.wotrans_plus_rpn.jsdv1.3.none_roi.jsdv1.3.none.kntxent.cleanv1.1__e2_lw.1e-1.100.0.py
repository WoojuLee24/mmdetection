    ...
    roi_head=dict(
        bbox_head=dict(
            ...
            loss_cls=dict(
                ...
                additional_loss2='kntxent.cleanv1.1', lambda_weight2=0, kpositive=20, classes=9),
...
log_config = dict(interval=100,
                  hooks=[
                      ...
                      #                         'name': "augmix.wotrans_plus_rpn.jsdv1.3.none_roi.jsdv1.3.none.kntxent.clean__e2_lw.1e-1.100.0",
                      #                         'config': {
                      #                             # data pipeline
