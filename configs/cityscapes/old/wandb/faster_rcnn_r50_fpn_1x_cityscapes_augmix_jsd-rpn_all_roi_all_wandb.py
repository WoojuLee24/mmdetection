                  ...
                  hooks=[
                      ...
                      dict(type='WandbLogger',
                           wandb_init_kwargs={'project': "AI28", 'entity': "ai28",
                                              'name': "augmix_with_jsd-rpn_all_roi_all-test_by_dshong",
                                              'config': {'augmix.layer_list': model['train_cfg']['augmix']['layer_list'],
                                                         'loss_type_list' : model['train_cfg']['loss_type_list'],
                                                         'jsd_loss_parameter' : model['train_cfg']['jsd_loss_parameter']}},
                           interval=500,
                           log_checkpoint=True,
