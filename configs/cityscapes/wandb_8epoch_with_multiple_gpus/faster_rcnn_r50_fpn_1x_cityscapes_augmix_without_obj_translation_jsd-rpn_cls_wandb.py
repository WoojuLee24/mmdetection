_base_ = [
    ...
    '../../_base_/schedules/ai28_8epoch.py',
...
name = f"augmix.{aug_list}_rpn.{rpn_loss_cls['additional_loss']}.{rpn_loss_bbox['additional_loss']}_roi.{roi_loss_cls['additional_loss']}.{roi_loss_bbox['additional_loss']}"
