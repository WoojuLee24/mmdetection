...
[OPTIONS] (updated 22.06.09)
  ...
  * loss_cls/loss_bbox.additional_loss
    : [None, 'jsd', 'jsdy', 'jsdv1_1', 'jsdv2', 'l1]
...
model = dict(
    rpn_head=dict(
        ...
        loss_bbox=dict(type='L1LossPlus', loss_weight=1.0
                       , additional_loss="l1_dg_loss", lambda_weight=1, wandb_name='rpn_bbox')),
    roi_head=dict(
        bbox_head=dict(
            loss_cls=dict(
                  ...
                  hooks=[
                      ...
                      dict(type='WandbLogger',
                           wandb_init_kwargs={'project': "AI28", 'entity': "kaist-url-ai28",
                                              'name': "augmix.wotrans_plus_rpn.jsdv1.3.l1_roi.jsdv1.3.none__e2_lw.1e-1.1.10",
                                              'config': {
                                                  # data pipeline
