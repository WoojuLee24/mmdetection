...
model = dict(
    rpn_head=dict(
        loss_cls=dict(
            ...
            , additional_loss='jsdv1_3_1', lambda_weight=0.1/768, wandb_name='rpn_cls'),
    ...
    roi_head=dict(
        bbox_head=dict(
            loss_cls=dict(
                ...
                , additional_loss='jsdv1_3_1', lambda_weight=10/1536, wandb_name='roi_cls'),
                  ...
                  hooks=[
                      ...
                      dict(type='WandbLogger',
                           wandb_init_kwargs={'project': "AI28", 'entity': "kaist-url-ai28",
                                              'name': "augmix.wotrans_plus_rpn.jsdv1.3.1.none_roi.jsdv1.3.1.none__e2_lw.1e-1.10_sameas1.3",
                                              'config': {
                                                  # data pipeline
