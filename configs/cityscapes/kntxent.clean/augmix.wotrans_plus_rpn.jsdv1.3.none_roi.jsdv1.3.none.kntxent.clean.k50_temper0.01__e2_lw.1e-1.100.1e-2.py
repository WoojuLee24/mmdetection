    ...
    roi_head=dict(
        bbox_head=dict(
            ...
            loss_cls=dict(
                ...
                additional_loss2='kntxent.clean', lambda_weight2=0.01, kpositive=50, classes=9, temper=0.01),
                  ...
                  hooks=[
                      ...
                      dict(type='WandbLogger',
                           wandb_init_kwargs={'project': "AI28", 'entity': "kaist-url-ai28",
                                              'name': "augmix.wotrans_plus_rpn.jsdv1.3.none_roi.jsdv1.3.none.kntxent.clean.k50_temper0.01__e2_lw.1e-1.100.1e-2",
                                              'config': {
                                                  # data pipeline
