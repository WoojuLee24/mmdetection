    ...
    roi_head=dict(
        bbox_head=dict(
            ...
            loss_cls=dict(
                ...
                additional_loss2='ntxent.clean.tr', lambda_weight2=0.01, temper=0.07, temper_ratio=0.2),
...
log_config = dict(interval=100,
                  hooks=[
                      ...
                      #                         'name': "augmix.wotrans_plus_rpn.jsdv1.3.none_roi.jsdv1.3.none.ntxent.clean_temper0.07_tr0.2__e2_lw.1e-1.100.1e-2",
                      #                         'config': {
                      #                             # data pipeline
