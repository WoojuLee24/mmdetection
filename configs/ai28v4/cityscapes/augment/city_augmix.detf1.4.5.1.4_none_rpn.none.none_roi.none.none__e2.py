...
train_pipeline = [
    ...
    ### AugMix ###
    dict(type='AugMixDetectionFaster', num_views=1, version='1.4.5.1.4',
         aug_severity=3, mixture_depth=-1, **img_norm_cfg,
         num_bboxes=(3, 5), scales=(0.01, 0.2), ratios=(0.3, 1/0.3),
         fillmode='box_blur', radius=10, margin_bg=True),
