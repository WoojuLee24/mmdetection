...
train_pipeline = [
    ...
    ### AugMix ###
    dict(type='AugMixDetection', num_views=1, version='1.5.7', aug_severity=3, mixture_depth=-1, **img_norm_cfg,
         num_bboxes=(3, 10), fillmode='img', return_bbox=True),
