...
train_pipeline = [
    ...
    ### AugMix ###
    dict(type='AugMixDetectionFaster', num_views=1, version='1.5.1.2.3',
         aug_severity=3, mixture_depth=-1, **img_norm_cfg, num_bboxes=(3, 5),
         fillmode='blur_margin', radius=10, radius_ratio=1/6, margin=3),
