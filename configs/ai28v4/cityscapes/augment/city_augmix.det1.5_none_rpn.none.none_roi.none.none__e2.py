...
train_pipeline = [
    ...
    ### AugMix ###
    dict(type='AugMixDetection', num_views=1, version='1.5', aug_severity=3, mixture_depth=-1, **img_norm_cfg,
         fillcolor=(128, 128, 128), num_bboxes=(3, 10)),
