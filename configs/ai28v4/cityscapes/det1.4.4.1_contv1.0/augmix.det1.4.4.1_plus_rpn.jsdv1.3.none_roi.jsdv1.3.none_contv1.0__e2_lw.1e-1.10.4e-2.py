...
model = dict(
    ...
    roi_head=dict(
        ...
        bbox_head=dict(
            ...
            loss_cont=dict(type='ContrastiveLossPlus', version='1.0', loss_weight=0.04, num_views=num_views,
...
train_pipeline = [
    ...
    ### AugMix ###
    dict(type='AugMixDetection', num_views=num_views, version='1.4.4.1',
         aug_severity=3, mixture_depth=-1, **img_norm_cfg,
         fillmode='blur', radius=10),
...
pipeline = 'augmix.det1.4.4.1'
loss_type = 'plus'
rpn_loss = 'jsdv1.3.none'
roi_loss = 'jsdv1.3.none.contv1.0'
lambda_weight = '1e-1.10.4e-2'
                  ...
                  hooks=[
                      ...
                      dict(type='WandbLogger',
                           wandb_init_kwargs={'project': "AI28v4", 'entity': "kaist-url-ai28",
                                              'name': "augmix.det1.4.4.1_plus_rpn.jsdv1.3.none_roi.jsdv1.3.none_contv1.0__e2_lw.1e-1.10.4e-2",
                                              'config': {
                                                  # data pipeline
