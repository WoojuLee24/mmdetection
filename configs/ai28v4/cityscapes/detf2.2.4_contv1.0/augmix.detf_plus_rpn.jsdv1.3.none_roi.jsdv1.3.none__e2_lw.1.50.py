...
model = dict(
    rpn_head=dict(
        loss_cls=dict(
            ...
            additional_loss='jsdv1_3_2aug', lambda_weight=1, wandb_name='rpn_cls'),
    ...
    roi_head=dict(
        bbox_head=dict(
            loss_cls=dict(
                ...
                additional_loss='jsdv1_3_2aug', lambda_weight=50, wandb_name='roi_cls', log_pos_ratio=True),
                  ...
                  hooks=[
                      ...
                      dict(type='WandbLogger',
                           wandb_init_kwargs={'project': "AI28v4", 'entity': "kaist-url-ai28",
                                              'name': "augmix.detf2.2.4_plus_rpn.jsdv1.3.none_roi.jsdv1.3.none_contv1.0__e2_lw.1.50",
                                              'config': {
                                                  # data pipeline
