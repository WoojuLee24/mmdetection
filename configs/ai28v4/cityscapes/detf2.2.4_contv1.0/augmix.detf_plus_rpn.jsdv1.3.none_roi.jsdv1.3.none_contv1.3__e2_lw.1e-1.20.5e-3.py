...
model = dict(
    ...
    roi_head=dict(
        ...
        bbox_head=dict(
            ...
            loss_cont=dict(type='ContrastiveLossPlus', version='1.3', loss_weight=0.005, num_views=num_views,
...
log_config = dict(interval=100,
                  hooks=[
                      ...
                      #                         'name': "augmix.detf2.2.4_plus_rpn.jsdv1.3.none_roi.jsdv1.3.none_contv1.0__e2_lw.1e-1.10.1e-2",
                      #                         'config': {
                      #                             # data pipeline
