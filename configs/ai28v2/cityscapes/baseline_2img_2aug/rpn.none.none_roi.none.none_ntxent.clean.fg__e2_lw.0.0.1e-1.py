    ...
    roi_head=dict(
        bbox_head=dict(
            ...
            loss_cls=dict(
                ...
                additional_loss2='ntxent.clean.fg', lambda_weight2=0.1),
...
loss_type = 'None'
rpn_loss = 'none.none'
roi_loss = 'none.none.ntxent_clean'
lambda_weight = '0.0.1e-1'
                  ...
                  hooks=[
                      ...
                      dict(type='WandbLogger',
                           wandb_init_kwargs={'project': "AI28", 'entity': "kaist-url-ai28",
                                              'name': "rpn.none.none_roi.none.none_ntxent.clean.orig.fg__e2_lw.0.0.1e-1_2img_2aug",
                                              'config': {
                                                  # data pipeline
