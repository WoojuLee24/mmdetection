    ...
    roi_head=dict(
        bbox_head=dict(
            ...
            loss_cls=dict(
                ...
                additional_loss2='ntxent.clean.fg.bg.tr', lambda_weight2=0.01, temper_ratio=0.9),
                  ...
                  hooks=[
                      ...
                      dict(type='WandbLogger',
                           wandb_init_kwargs={'project': "AI28", 'entity': "kaist-url-ai28",
                                              'name': "augmix.det1.2_plus_rpn.jsdv1.3.none_roi.jsdv1.3.none_ntxent.clean.fg.bg.tr0.9__e2_lw.1e-1.1.1e-2_2img_2aug",
                                              'config': {
                                                  # data pipeline
