...
model = dict(
    ...
    roi_head=dict(
        ...
        bbox_head=dict(
            ...
            loss_cont=dict(type='ContrastiveLossPlus', version='1.2', loss_weight=0.001, num_views=num_views,
...
roi_loss = 'jsdv1.3.none.contv1.2'
lambda_weight = '1e-1.10.1e-3'
                  ...
                  hooks=[
                      ...
                      dict(type='WandbLogger',
                           wandb_init_kwargs={'project': "AI28", 'entity': "kaist-url-ai28",
                                              'name': "augmix.det1.4_plus_rpn.jsdv1.3.none_roi.jsdv1.3.none_contv1.2__e2_lw.1e-1.10.1e-3",
                                              'config': {
                                                  # data pipeline
