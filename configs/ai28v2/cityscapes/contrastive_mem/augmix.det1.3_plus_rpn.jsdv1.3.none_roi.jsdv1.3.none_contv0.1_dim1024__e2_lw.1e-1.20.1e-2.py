...
model = dict(
    ...
    roi_head=dict(
        ...
        bbox_head=dict(
            ...
            with_cont=True,
            cont_predictor_cfg=dict(num_linear=2, feat_channels=1024, return_relu=True),
            loss_cls=dict(
            ...
            loss_cont=dict(type='ContrastiveLossPlus', version='0.1', loss_weight=0.01, num_views=num_views,
                           memory=0, num_classes=9, dim=1024)
        ),
    ),
    train_cfg=dict(
        wandb=dict(
                  ...
                  hooks=[
                      ...
                      dict(type='WandbLogger',
                           wandb_init_kwargs={'project': "AI28", 'entity': "kaist-url-ai28",
                                              'name': "augmix.det1.3_plus_rpn.jsdv1.3.none_roi.jsdv1.3.none_contv0.1__e2_lw.1e-1.20.1e-2",
                                              'config': {
                                                  # data pipeline
