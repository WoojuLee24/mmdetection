...
model = dict(
    ...
    roi_head=dict(
        ...
        bbox_head=dict(
            ...
            loss_cont=dict(type='ContrastiveLossPlus', version='0.2', loss_weight=0.03, num_views=num_views,
                           memory=0, num_classes=9, dim=256,
                           iou_th=0.5, iou_act='clip')
        ),
    ),
    train_cfg=dict(
        wandb=dict(
                  ...
                  hooks=[
                      ...
                      dict(type='WandbLogger',
                           wandb_init_kwargs={'project': "AI28", 'entity': "kaist-url-ai28",
                                              'name': "augmix.det1.4_plus_rpn.jsdv1.3.none_roi.jsdv1.3.none_contv0.2_clip0.5__e2_lw.1e-1.10.3e-2",
                                              'config': {
                                                  # data pipeline
