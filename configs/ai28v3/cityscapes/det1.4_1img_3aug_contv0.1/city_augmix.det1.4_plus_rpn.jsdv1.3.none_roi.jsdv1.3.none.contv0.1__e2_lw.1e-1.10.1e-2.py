...
model = dict(
    ...
    roi_head=dict(
        ...
        bbox_head=dict(
            ...
            loss_cont=dict(type='ContrastiveLossPlus', version='0.1', loss_weight=0.01,
                  ...
                  hooks=[
                      ...
                      dict(type='WandbLogger',
                           wandb_init_kwargs={'project': "AI28v3", 'entity': "kaist-url-ai28",
                                              'name': "city_augmix.det1.4_plus_rpn.jsdv1.3.none_roi.jsdv1.3.none.contv0.1__e2_lw.1e-1.10.1e-2",
                                              'config': {
                                                  # data pipeline
