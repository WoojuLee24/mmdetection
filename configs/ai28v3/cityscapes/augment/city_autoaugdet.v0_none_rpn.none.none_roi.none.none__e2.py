...
### DATASET ###
###############
custom_imports = dict(imports=['mmdet.datasets.pipelines.auto_augment'], allow_failed_imports=False)
img_norm_cfg = dict(
...
train_pipeline = [
    ...
    ### AutoAugment ###
    dict(type='AutoAugDet',
        # Autoaugment policy that was used in AutoAugment Detection Paper.
         policies='v0',
         num_gen=1, no_jsd=True),
