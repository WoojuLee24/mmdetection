...
from mmdet.apis import multi_gpu_test, set_random_seed, single_gpu_test, single_gpu_analysis_background
    ...
    for corr_i, corruption in enumerate(corruptions):
        ...
        for sev_i, corruption_severity in enumerate(args.severities):
            ...
            if not distributed:
                ...
                outputs = single_gpu_analysis_background(model, data_loader, args.show,
